        ...
        h = function (e, t) {
            ...
            switch (e) {
                case 0:
                    n = {
                        code: e,
                        message: "Virtual Mouse can't run in your browser :("
                    };
                    break;
                case 1:
                    n = {
                        code: e,
                        message: "Virtual Mouse could not start."
                    };
                    break;
                case 2:
                    n = {
                        code: e,
                        message: "Virtual Mouse has already started."
                    };
                    break;
                case 10:
                    n = {
                        code: e,
                        message: "DEEENIED! Virtual Mouse needs webcam access.",
                        obj: t
                    };
                    break;
                case 11:
...
gest.start(), gest.options.subscribeWithCallback(function (e) {
    ...
    e.up && window.scrollBy(0, -5e3),
        e.down && window.scrollBy(0, 5e3),
        e.left && (curr_zoom -= 10, document.body.style.zoom = curr_zoom + "%"),
        e.right && (curr_zoom += 10, document.body.style.zoom = curr_zoom + "%")
